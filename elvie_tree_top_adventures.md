...
![Elvie climbing the oak tree](elvie_climbing_tree.PNG)
...
![View from the tree-top with Broke Leg Falls visible](elvie_tree_view.PNG)
...
![Eliza Jane calling from below](eliza_jane_calling.PNG)
...
![Elvie landing safely](elvie_landing.PNG)
